  ...
  return (
    <div className="space-y-6 print:space-y-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-800/80 print:pb-1.5 print:border-slate-200">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-100 print:text-slate-900 print:text-xs tracking-tight">
        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          <span className="hidden print:inline-block text-[10px] font-bold text-slate-900 border border-slate-300 bg-slate-50 px-2 py-0.5 rounded">
            Volume Batch: {moistureInputs.batchVolumeM3} m³
          </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 print:gap-3">
        ...
        <div className="lg:col-span-5 bg-[#131b26] rounded-xl border border-slate-800/80 p-5 space-y-5 shadow-2xl print:col-span-5 print:bg-white print:border print:border-slate-300 print:p-2.5 print:space-y-2 print:shadow-none">
          <h3 className="text-sm font-bold text-slate-100 print:text-slate-900 print:text-xs flex items-center gap-2 border-b border-slate-800/80 print:border-slate-200 pb-3 print:pb-1">
          ...
          <div className="bg-[#0c121a] border border-slate-700/60 rounded-xl p-4 space-y-3 print:bg-slate-50 print:border print:border-slate-200 print:p-2 print:space-y-1">
            <div className="flex items-center justify-between">
              <div className="font-semibold text-xs text-slate-200 print:text-slate-900 print:text-[10px] flex items-center gap-1.5">
                <span>Agregat Halus (Pasir)</span>
              </div>
              <span className="text-[11px] font-mono px-2.5 py-0.5 rounded-full bg-[#131b26] border border-slate-700 text-slate-300 print:bg-white print:border print:border-slate-300 print:text-slate-700 print:text-[9px] print:px-1.5 print:py-0">
                Air Bebas:{' '}
                <strong
                  className={
        ...
        <div className="lg:col-span-7 space-y-4 print:space-y-2">
          ...
          <div
            className={`border rounded-xl p-5 shadow-2xl transition print:p-2.5 print:shadow-none print:rounded-lg ${
              isDeductingWater
                ? 'bg-amber-950/40 border-amber-800/60 text-amber-200 print:bg-amber-50/80 print:border print:border-amber-300 print:text-amber-950'
                : 'bg-sky-950/40 border-sky-800/60 text-sky-200 print:bg-sky-50/80 print:border print:border-sky-300 print:text-sky-950'
            }`}
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 print:gap-2">
              <div className="flex-1 min-w-0">
                <span className="text-[10px] uppercase font-bold tracking-wider px-2.5 py-0.5 rounded-full bg-[#131b26] border border-slate-700 text-slate-300 print:bg-white print:border print:border-slate-300 print:text-slate-700 shadow-xs inline-block print:text-[9px] print:px-1.5 print:py-0">
                  Instruksi Lapangan Operator Batching Plant
                </span>
                <h4 className="text-base sm:text-lg font-bold text-slate-100 print:text-slate-900 print:text-xs mt-2 print:mt-1 flex items-center gap-2 break-words whitespace-normal leading-tight">
                  {isDeductingWater ? (
                    <>
                      <TrendingDown className="w-5 h-5 text-amber-400 print:text-amber-700 shrink-0 print:w-3.5 print:h-3.5" />
                      <span>Koreksi Air: PENGURANGAN AIR MIXER</span>
                    </>
                  ) : (
                    <>
                      <TrendingUp className="w-5 h-5 text-sky-400 print:text-sky-700 shrink-0 print:w-3.5 print:h-3.5" />
                      <span>Koreksi Air: PENAMBAHAN AIR MIXER</span>
                    </>
                  )}
                </h4>
                <p className="text-xs text-slate-300 print:text-slate-700 print:text-[10px] mt-1 max-w-xl leading-relaxed break-words whitespace-normal">
                  {isDeductingWater ? (
                    <>
                      Agregat mengandung kelembaban bebas permukaan. Volume air dispenser{' '}
                      <strong className="text-amber-400 font-semibold print:text-amber-900">HARUS DIKURANGI</strong> agar w/c tidak jebol.
                    </>
                  ) : (
                    <>
                      Agregat menyerap air (Air Bebas Negatif). Tambahkan air agar hidrasi optimal.
                    </>
                  )}
                </p>
              </div>
              ...
              <div className="shrink-0 text-left sm:text-right">
                <div className="text-xs text-slate-400 print:text-slate-600 font-medium print:text-[10px]">Koreksi per m³:</div>
                <div
                  className={`text-2xl sm:text-3xl font-mono font-extrabold print:text-xl ${
                    isDeductingWater ? 'text-amber-400 print:text-amber-800' : 'text-sky-400 print:text-sky-800'
                  }`}
                >
                  {batchingOutputs.waterAdjustmentKgPerM3 > 0 ? '+' : ''}
                  {batchingOutputs.waterAdjustmentKgPerM3.toFixed(1)}{' '}
                  <span className="text-xs font-normal text-slate-400 print:text-slate-600 print:text-[10px]">L/m³</span>
                </div>
              </div>
            </div>

            {/* Scale for Full Truck */}
            <div className="mt-4 pt-4 border-t border-slate-800/80 print:mt-2 print:pt-1.5 print:border-slate-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-[#0c121a] border border-slate-800 p-3.5 rounded-xl print:bg-white print:border print:border-slate-200 print:p-1.5 shadow-xs">
              <div className="flex items-center gap-2.5">
                <Truck className="w-5 h-5 text-amber-400 print:text-amber-700 shrink-0 print:w-4 print:h-4" />
                <div>
                  <div className="text-xs font-bold text-slate-200 print:text-slate-900 print:text-[11px]">
                    Total Koreksi Air Truk Mixer ({moistureInputs.batchVolumeM3} m³):
                  </div>
                  <div className="text-[11px] text-slate-400 print:text-slate-500 print:text-[9px]">
                    Koreksi debit air dispenser mixer
                  </div>
                </div>
              </div>

              <div className="text-right">
                <div className="text-xl sm:text-2xl font-mono font-extrabold text-amber-400 print:text-amber-800 print:text-base">
                  {batchingOutputs.totalActualWaterCorrectionKg > 0 ? '+' : ''}
                  {batchingOutputs.totalActualWaterCorrectionKg.toFixed(1)}{' '}
                  <span className="text-xs font-normal text-slate-400 print:text-slate-600 print:text-[10px]">Liter</span>
                </div>
                <div className="text-[10px] text-slate-400 print:text-slate-600 font-medium print:text-[9px]">
                  Air Teoritis: {(mixOutputs.waterKg * moistureInputs.batchVolumeM3).toFixed(0)} L → Aktual:{' '}
                  <strong className="font-mono font-bold text-white print:text-slate-900">
          ...
          <div className="bg-[#131b26] border border-slate-800/80 rounded-xl p-5 shadow-2xl print:bg-white print:border print:border-slate-300 print:p-2.5 print:shadow-none">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800/80 print:pb-1.5 print:border-slate-200">
              <h3 className="text-sm font-bold text-slate-100 print:text-slate-900 print:text-xs flex items-center gap-2">
              ...
              <span className="text-xs font-mono px-2 py-0.5 rounded-full bg-[#0c121a] text-slate-300 border border-slate-700 print:bg-slate-50 print:text-slate-700 print:border-slate-300 print:text-[9px]">
                Kondisi Lapangan Basah
              </span>
            </div>

            <div className="overflow-x-auto mt-3 print:mt-1.5">
              <table className="w-full text-left text-xs font-mono">
                <thead>
                  <tr className="border-b border-slate-800 text-slate-400 print:border-slate-200 print:text-slate-600 font-sans font-semibold print:text-[9px]">
                    <th className="py-2.5 pr-2 print:py-1">Material</th>
                    <th className="py-2.5 px-2 text-right print:py-1">Teoritis SSD (1 m³)</th>
                    <th className="py-2.5 px-2 text-right text-slate-300 print:text-slate-700 print:py-1">Aktual Lapangan (1 m³)</th>
                    <th className="py-2.5 pl-2 text-right text-emerald-400 print:text-emerald-800 font-bold font-mono print:py-1">
                ...
                <tbody className="divide-y divide-slate-800/60 text-slate-300 print:divide-slate-200 print:text-slate-800">
                  {/* Water */}
                  <tr className="hover:bg-slate-800/30 print:hover:bg-slate-50">
                    <td className="py-2.5 pr-2 font-sans text-slate-200 print:text-slate-900 flex items-center gap-1.5 font-medium print:py-1 print:text-[10px]">
                      <Droplet className="w-3.5 h-3.5 text-sky-400 print:text-sky-700" />
                      <span>Air Bersih (Water)</span>
                    </td>
                    <td className="py-2.5 px-2 text-right text-slate-400 print:text-slate-600 print:py-1 print:text-[10px]">
                      {mixOutputs.waterKg.toFixed(1)} L
                    </td>
                    <td className="py-2.5 px-2 text-right text-sky-400 print:text-sky-800 font-bold print:py-1 print:text-[10px]">
                      {batchingOutputs.actualWaterKgPerM3.toFixed(1)} L
                    </td>
                    <td className="py-2.5 pl-2 text-right text-emerald-400 print:text-emerald-800 font-bold text-sm print:py-1 print:text-[11px]">
                  ...
                  <tr className="hover:bg-slate-800/30 print:hover:bg-slate-50">
                    <td className="py-2.5 pr-2 font-sans text-slate-200 print:text-slate-900 flex items-center gap-1.5 font-medium print:py-1 print:text-[10px]">
                      <span className="w-3.5 h-3.5 rounded-md bg-slate-500 print:bg-slate-400 inline-block" />
                      <span>Semen Portland (Cement)</span>
                    </td>
                    <td className="py-2.5 px-2 text-right text-slate-400 print:text-slate-600 print:py-1 print:text-[10px]">
                      {mixOutputs.cementKg.toFixed(1)} kg
                    </td>
                    <td className="py-2.5 px-2 text-right text-white print:text-slate-900 font-semibold print:py-1 print:text-[10px]">
                  ...
                  <tr className="hover:bg-slate-800/30 print:hover:bg-slate-50">
                    ...
                    <td className="py-2.5 px-2 text-right text-amber-400 print:text-amber-800 font-semibold print:py-1 print:text-[10px]">
                  ...
                  <tr className="hover:bg-slate-800/30 print:hover:bg-slate-50">
                    ...
                    <td className="py-2.5 px-2 text-right text-emerald-400 print:text-emerald-800 font-semibold print:py-1 print:text-[10px]">
                  ...
                  {/* Total Batch Weight */}
                  <tr className="bg-[#0c121a] font-bold border-t border-slate-700/80 print:bg-slate-100 print:border-t-2 print:border-slate-400">
                    <td className="py-2.5 pr-2 font-sans text-white print:text-slate-900 print:py-1 print:text-[10px]">Total Muatan Truk:</td>
                    <td className="py-2.5 px-2 text-right text-slate-400 print:text-slate-600 print:py-1 print:text-[10px]">
                      {(
                        (mixOutputs.waterKg +
                          mixOutputs.cementKg +
                    ...
                    <td className="py-2.5 px-2 text-right text-white print:text-slate-900 print:py-1 print:text-[10px]">
                      {(
                    ...
                    <td className="py-2.5 pl-2 text-right text-emerald-400 print:text-emerald-800 text-sm font-extrabold print:py-1 print:text-xs">
                      {(
                        (batchingOutputs.actualWaterKgPerM3 +
                          batchingOutputs.actualCementKgPerM3 +
                          batchingOutputs.actualSandKgPerM3 +
            ...
            <div className="mt-3 pt-3 text-[11px] text-slate-400 print:text-slate-500 flex items-center justify-between border-t border-slate-800/80 print:mt-1.5 print:pt-1 print:border-slate-200 print:text-[9px]">
